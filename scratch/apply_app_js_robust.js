...
// 1. Declare currentUserRole globally near currentUsername
const oldUsernameDecl = "  let currentUsername = '';";
const newUsernameDecl = "  let currentUsername = '';\n  let currentUserRole = '';";

if (content.includes(newUsernameDecl)) {
  console.log("currentUserRole already declared globally!");
} else if (content.includes(oldUsernameDecl)) {
...
if (content.includes(newAdminCheck)) {
  console.log("Admin check already updated in checkLoginState!");
} else if (content.includes(oldAdminCheck)) {
...
if (content.includes(newMainTabBlock)) {
  console.log("switchMainTab block already restructured!");
} else if (content.includes(oldMainTabBlock)) {
...
if (content.includes(newClassroomSwitcher)) {
  console.log("Classroom subtab switcher block already restructured!");
} else if (content.includes(oldClassroomSwitcher)) {
...
// 5. Replace references of guest state hiders so that settings-section gets hidden on guest state
